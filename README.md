...
> ⚠️ **Important:** This frontend application works in conjunction with the backend server. Before running the application, you must ensure the backend server is running and properly configured with a `.env` file containing your AI API key. See the installation section for complete setup details.
